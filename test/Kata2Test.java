...
public class Kata2Test {
    ...
    public void testRecursiveChop() {
        assertEquals(-1, kata.recursive_chop(3, new int[]{}));
        assertEquals(-1, kata.recursive_chop(3, new int[]{1}));
        assertEquals(0,  kata.recursive_chop(1, new int[]{1}));
        //------------------------
        assertEquals(0,  kata.recursive_chop(1, new int[]{1, 3, 5}));
        assertEquals(1,  kata.recursive_chop(3, new int[]{1, 3, 5}));
        assertEquals(2,  kata.recursive_chop(5, new int[]{1, 3, 5}));
        assertEquals(-1, kata.recursive_chop(0, new int[]{1, 3, 5}));
        assertEquals(-1, kata.recursive_chop(2, new int[]{1, 3, 5}));
        assertEquals(-1, kata.recursive_chop(4, new int[]{1, 3, 5}));
        assertEquals(-1, kata.recursive_chop(6, new int[]{1, 3, 5}));
        //------------------------
        assertEquals(0,  kata.recursive_chop(1, new int[]{1, 3, 5, 7}));
        assertEquals(1,  kata.recursive_chop(3, new int[]{1, 3, 5, 7}));
        assertEquals(2,  kata.recursive_chop(5, new int[]{1, 3, 5, 7}));
        assertEquals(3,  kata.recursive_chop(7, new int[]{1, 3, 5, 7}));
        assertEquals(-1, kata.recursive_chop(0, new int[]{1, 3, 5, 7}));
        assertEquals(-1, kata.recursive_chop(2, new int[]{1, 3, 5, 7}));
        assertEquals(-1, kata.recursive_chop(4, new int[]{1, 3, 5, 7}));
        assertEquals(-1, kata.recursive_chop(6, new int[]{1, 3, 5, 7}));
        assertEquals(-1, kata.recursive_chop(8, new int[]{1, 3, 5, 7}));
    }
